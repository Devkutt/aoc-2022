...
const overlapping = ranges.filter(pair => {
    return (
        (pair[0][0] <= pair[1][0] && pair[0][1] >= pair[1][1] || pair[1][0] <= pair[0][0] && pair[1][1] >= pair[0][1])
         || (pair[0][0] <= pair[1][0] && pair[0][1] >= pair[1][0] || pair[0][0] <= pair[1][1] && pair[0][1] >= pair[1][1])
         || (pair[1][0] <= pair[0][0] && pair[1][1] >= pair[0][0] || pair[1][0] <= pair[0][1] && pair[1][1] >= pair[0][1])
    )
});
